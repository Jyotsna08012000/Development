            ...
            <section class="typo-section py-4 border-top border-bottom">
               ...
               <form action="SellerController "method="post">
                <div class="form-group">
                     ...
                     <input type="hidden" class="form-control" name="id" id="inputpassword" value="<%=s.getId()%>">
                       </div>
               <div class="form-group">
                     <label for="inputpassword">Old Password</label>
                     <input type="password" class="form-control" name="op" id="inputpassword" placeholder="Old Password">
                       </div>
                        <div class="form-group">
                     <label for="inputpassword">New Password</label>
                     <input type="password" class="form-control" name="np" id="inputpassword" placeholder="New Password">
                       </div>
                        <div class="form-group">
                     <label for="inputpassword">Confirm Password</label>
                     <input type="password" class="form-control" name="cnp" id="inputpassword" placeholder="confirm Password">
                       </div>
                </select>
                </div>
