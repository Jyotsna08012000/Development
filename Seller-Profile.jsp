                     ...
                     <li class="nav-item ">
                      ...
                      <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                           ...
                           <a class="nav-link " href="seller-mannage-product.jsp">Mannage Product</a>                          
                        </div>
                     </li>
                      <li class="nav-item dropdown active">
                       ...
                       <%=s.getName() %>
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                           ...
                           <a class="nav-link" href="Seller-ChangePassword.jsp">Change Password</a>
         ...
         <div class="container py-xl-5 py-sm-3">
            ...
            <section class="typo-section py-4 border-top border-bottom">
               ...
               <div class="form-group">
                     ...
                     <input type="text" class="form-control" name="name" id="inputname" value="<%=s.getName()%>">
                  </div>
                  <div class="form-group">
                     <label for="inputcontact">Contact</label>
                     <input type="text" class="form-control" name="contact" id="inputcontact" value="<%= s.getContact() %>">
                  </div>
                  <div class="form-row">
                     <div class="form-group col-md-6">
                        <label for="inputemail4">Email</label>
                        <input type="email" class="form-control" name="email" id="inputemail4" value=" <%= s.getEmail() %>">
                     </div>
                    
                  </div>
                  <div class="form-group">
                     <label for="inputaddress">Address</label>
                     <input type="text" class="form-control" name="address" id="inputaddress" value="<%= s.getAddress() %>">
                  </div>
                 
                  <div class="form-row">
                     <div class="form-group col-md-6">
                        <label for="inputcity">City</label>
                        <input type="text" class="form-control" name="city" id="inputcity"value="<%=s.getCity() %>">
                     </div>
                     <div class="form-row">
                     <div class="form-group col-md-6">
                        <label for="inputstate">State</label>
                        <input type="text" class="form-control" name="state" id="inputstate"value="<%= s.getState() %>">
                     </div>
                        </select>
                     </div>
