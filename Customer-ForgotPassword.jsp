   ...
   <body>
      ...
      <div class="using-border py-3">
         <div class="inner_breadcrumb  ml-4">
            ...
            <h3 class="title text-center mb-lg-5 mb-md-4 mb-sm-4 mb-3">Forgot Password</h3>
            ...
            <section class="typo-section py-4 border-top border-bottom">
               ...
               <form action="CustomerController"method="post">
                  ...
                  <button type="submit" class="btn btn-primary"  name="action"  value ="GET OTP" >GET OTP</button>
               </form>
        </section>
