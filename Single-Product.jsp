               ...
               <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
                  <ul class="navbar-nav ">
                     <li class="nav-item active">
                        <a class="nav-link" href="Customaer-home.jsp">Home <span class="sr-only">(current)</span></a>
                     </li>
                      ...
                      <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                           ...
                           <a class="nav-link " href="Customer-wishlist.jsp">WishList</a>                          
                        </div>
                     </li>
                      <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown1" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
         ...
         <div class="container">
			...
			%>
                        ...
                        <div class="flexslider1">
                           <ul class="slides">
                              <li data-thumb="images/f2.jpg">
                                 <div class="thumb-image"> <img src="image/<%=p.getImage() %>" data-imagezoom="true" class="img-fluid" alt=" "> </div>
                              </li>
                  ...
                  <div class="col-lg-8 single-right-left simpleCart_shelfItem">
                     ...
                     <p><span class="item_price">Price:- Rs.<%=p.getPprice() %></span>  </p>
                      <p><span class="item_price">Type:- <%=p.getPcategory()%></span>  </p>
                       <p><span class="item_price">Description:- <%=p.getPdesc() %></span>  </p>
                  ...
                  <div class="responsive_tabs">
					...
					<%if(flag == false){ %>
						...
						<input type="hidden" name="cusid" value="<%=c.getId()%>">
                              <button name="action" value="addtowishlist" class="toys-cart ptoys-cart add">
                              Add to WishList
                              </button>
                           </form>
                           <%} %>
                      ...
                      <div class="occasion-cart">
                        <div class="toys single-item singlepage">
                           ...
                           <input type="hidden" name="pid" value="<%=p.getPid()%>">
						<input type="hidden" name="cusid" value="<%=c.getId()%>">
                              <button  name="action" value="addtocart" class="toys-cart ptoys-cart add">
                              Add to Cart
                              </button>
                           </form>
