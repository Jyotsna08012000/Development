      ...
      <div class="header-outs" id="home">
       ...
       <section class="inner-pages py-5">
         ...
         <div class="container py-xl-5 py-sm-3">
            <h3 class="title text-center mb-lg-5 mb-md-4 mb-sm-4 mb-3">Customer Change Password</h3>
            ...
            <section class="typo-section py-4 border-top border-bottom">
               ...
               <form action="CustomerController "method="post">
                <div class="form-group">
                     ...
                     <input type="hidden" class="form-control" name="id" id="inputpassword" value="<%=c.getId()%>">
                       </div>
               <div class="form-group">
