                     ...
                     <li class="nav-item">
                      ...
                      <li class="nav-item dropdown active">
                       ...
                       Login
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                           <a class="nav-link" href="Seller-Login.jsp">As Seller</a>
                           <a class="nav-link" href="Customer-Login.jsp">As Customer</a>
                            <a class="nav-link" href="Admin-Login.jsp">As Admin</a>
                        </div>
                     </li>
      ...
      <div class="using-border py-3">
         <div class="inner_breadcrumb  ml-4">
            ...
            <h3 class="title text-center mb-lg-5 mb-md-4 mb-sm-4 mb-3">New Password</h3>
             ...
             <h6 class="title text-center mb-lg-5 mb-md-4 mb-sm-4 mb-3">
              ...
              <input type="hidden" name="email" value="<%=email%>">
                  ...
                  <div class="form-row">
                     <div class="form-group col-md-6">
                        ...
                        <input type="password" class="form-control" name="np" id="inputemail4" placeholder=" Enter New Password">
                     </div>
                     
                     <div class="form-group col-md-6">
                        <label for="inputpassword4">Confirm New Password</label>
                        <input type="password" class="form-control" name="cnp" id="inputpassword4" placeholder="Enter Confirm New Password">
                     </div>
                      <button type="submit" class="btn btn-primary"  name="action"  value ="Change Password" >Change Password</button>
                 </div>
           </form>
