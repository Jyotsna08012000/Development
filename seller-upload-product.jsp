   ...
   %>
      ...
      <section class="inner-pages py-5">
         <div class="container py-xl-5 py-sm-3">
            <h3 class="title text-center mb-lg-5 mb-md-4 mb-sm-4 mb-3">Upload Product</h3>
            <!-- forms -->
            <section class="typo-section py-4 border-top border-bottom">
               ...
               <div class="form-group">
                  ...
                  <div class="form-group">
                     ...
                     <input type="text" class="form-control" name="pdesc" placeholder="product description" required="">
                  </div>
