      ...
      <div class="using-border py-3">
         <div class="inner_breadcrumb  ml-4">
            ...
            <h3 class="title text-center mb-lg-5 mb-md-4 mb-sm-4 mb-3">Verify OTP</h3>
             ...
             <h7 class="title text-center mb-lg-5 mb-md-4 mb-sm-4 mb-3">
               ...
               <form action="CustomerController"method="post">
                  ...
                  <input type="hidden" name="email" value="<%=email%>">
                     ...
                     <div class="form-group col-md-6">
                        <label for="inputeOTP">OTP</label>
                        <input type="text" class="form-control" name="otp2" id="inputemail4" placeholder="Enter OTP">
                     </div>
                    
                  <button type="submit" class="btn btn-primary"  name="action"  value ="verify" >verify</button>
                  </div>
               </form>
